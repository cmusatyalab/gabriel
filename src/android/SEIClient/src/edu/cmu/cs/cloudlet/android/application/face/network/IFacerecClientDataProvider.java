...
public interface IFacerecClientDataProvider {
	
	public void registerActivityCallback(String className, IFacerecClientDataListener activityCallback);
	
	public void unregisterActivityCallback(String className);

	public void sendImageData(RawPreviewImageInfo imageData);
