...
public class SpeechPreferenceActivity extends android.preference.PreferenceActivity implements OnSharedPreferenceChangeListener, OnPreferenceClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		addPreferencesFromResource(R.xml.speech_preferences);
	...
	public boolean onPreferenceClick(Preference preference) 
	{
		...
		{
			Intent intent = new Intent( SpeechPreferenceActivity.this, FileBrowserActivity.class );
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) 
	{
		...
		case FILE_BROWSER_REQUEST_CODE:
			...
			case RESULT_OK:
				...
				SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences( SpeechPreferenceActivity.this ).edit();
