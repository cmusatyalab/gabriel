...
from mar_client import send_request
...
class MARThread(AppProxyThread):
    ...
    def handle(self, header, data):
        ...
        ret_name = send_request(self.app_sock, data)
...
if __name__ == "__main__":
    ...
    try:
        ...
        mar_thread = MARThread(app_addr, image_queue, output_queue_list)
        mar_thread.start()
        mar_thread.isDaemon = True 
