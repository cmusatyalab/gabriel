from .mobile_server import input_display_queue, output_display_queue_dict, image_queue_list, acc_queue_list, audio_queue_list, gps_queue_list, result_queue, command_queue
