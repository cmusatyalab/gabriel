...
namespace HoloToolkit.Unity
{
    ...
    public partial class MyTapToPlace : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("Maximum placement distance, in meters, for calculating a hit.")]
        ...
        private void Update()
        {
            ...
            if (placing)
            {
                ...
                if (Physics.Raycast(headPosition, gazeDirection, out hitInfo,
                    MaxDistance, spatialMappingManager.LayerMask))
                {
                ...
                {
                    this.transform.position = headPosition + (gazeDirection * MaxDistance);
                }
