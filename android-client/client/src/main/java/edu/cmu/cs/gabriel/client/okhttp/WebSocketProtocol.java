// Based on https://github.com/square/okhttp/blob/parent-3.11.0/okhttp/src/main/java/okhttp3/internal/ws/WebSocketProtocol.java
// I had to copy this because files in this package could not access fields from
